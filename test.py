...
It will load a saved model from --checkpoints_dir and save the results to --checkpoints_dir.
...
Example (You need to train models first or download pre-trained models from our website):
    ...
    Use '--checkpoints_dir <directory_path_to_save_result>' to specify the results directory.
